...
- [ITMO Computer Science Group](https://github.com/ITMO-Computer-Science-Group/ITMO-Computer-Science-Group)
    - 本组织的所有仓库的公共文档和本组织的文档
    - 维护者：
        - [Ranying](https://github.com/Ran-ying)
- [Russian Language Studying](https://github.com/ITMO-Computer-Science-Group/Russian-Language-Studying/)
    - 俄语语言学习仓库
    - 维护者：
        - [Ranying](https://github.com/Ran-ying)
    - 贡献者：
        ...
        - [GreatTyron](https://github.com/GreatTyron)
        - [D-benlala](https://github.com/D-benlala)
- [Preparatory Courses](https://github.com/ITMO-Computer-Science-Group/Preparatory-Courses)
    - 预科课程学习仓库
    - 维护者：
        - [Tolia-GH](https://github.com/Tolia-GH)
        - [Ranying](https://github.com/Ran-ying)
    - 贡献者：
        ...
        - [GreatTyron](https://github.com/GreatTyron)
        - [D-benlala](https://github.com/D-benlala)
- [Common Courses](https://github.com/ITMO-Computer-Science-Group/Common-Courses)
    - 公共课学习仓库
...
- 内容生产
  ...
  - history content
- 内容消费
  - Russian Language Studying 部分由 [Daily Words](https://www.ranying.xyz/api/Daily-Words/) 进行消费
